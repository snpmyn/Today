...
public abstract class BaseExtraTransaction {
     ...
     * @return BaseExtraTransaction
     */
    public abstract BaseExtraTransaction setCustomAnimations(@AnimatorRes @AnimRes int targetFragmentEnter, @AnimatorRes @AnimRes int currentFragmentPopExit, @AnimatorRes @AnimRes int currentFragmentPopEnter, @AnimatorRes @AnimRes int targetFragmentExit);
    ...
    final static class BaseExtraTransactionImpl<T extends ISupportFragment> extends BaseExtraTransaction implements DoNotAddToBackStackTransaction {
        ...
        @Override
        public BaseExtraTransaction setCustomAnimations(@AnimRes int targetFragmentEnter, @AnimRes int currentFragmentPopExit, @AnimRes int currentFragmentPopEnter, @AnimRes int targetFragmentExit) {
            mRecord.targetFragmentEnter = targetFragmentEnter;
            mRecord.currentFragmentPopExit = currentFragmentPopExit;
