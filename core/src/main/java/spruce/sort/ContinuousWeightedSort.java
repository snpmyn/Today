...
public class ContinuousWeightedSort extends ContinuousSort {
     ...
     */
    public ContinuousWeightedSort(long interObjectDelay, boolean reversed, Position position, @FloatRange(from = 0.0) double horizontalWeight, @FloatRange(from = 0.0) double verticalWeight) {
