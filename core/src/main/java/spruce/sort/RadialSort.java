    ...
    public PointF getDistancePoint(ViewGroup parent, List<View> children) {
        ...
        switch (position) {
            case TOP_LEFT:
                ...
                break;
            case TOP_MIDDLE:
                distancePoint = new PointF((float) parent.getWidth() / 2, 0);
                break;
            case TOP_RIGHT:
                distancePoint = new PointF(parent.getWidth(), 0);
                break;
            case LEFT:
                distancePoint = new PointF(0, (float) parent.getHeight() / 2);
                break;
            case MIDDLE:
                distancePoint = new PointF((float) parent.getWidth() / 2, (float) parent.getHeight() / 2);
                break;
            case RIGHT:
                distancePoint = new PointF(parent.getWidth(), (float) parent.getHeight() / 2);
                break;
            case BOTTOM_LEFT:
                distancePoint = new PointF(0, parent.getHeight());
                break;
            case BOTTOM_MIDDLE:
                distancePoint = new PointF((float) parent.getWidth() / 2, parent.getHeight());
                break;
            case BOTTOM_RIGHT:
