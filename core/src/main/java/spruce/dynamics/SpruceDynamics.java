...
public abstract class SpruceDynamics<T extends SpruceDynamics<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final ViewProperty TRANSLATION_X = new ViewProperty("translationX") {
        ...
        @Override
        public float getValue(@NonNull View view) {
     ...
     */
    @SuppressLint("MinMaxConstant")
    public static final float MIN_VISIBLE_CHANGE_ROTATION_DEGREES = 1.0f / 10.0F;
    /**
     * The minimum visible change in alpha that can be visible to users.
     */
    @SuppressLint("MinMaxConstant")
    public static final float MIN_VISIBLE_CHANGE_ALPHA = 1.0f / 256.0F;
    /**
     * The minimum visible change in scale that can be visible to users.
     */
    @SuppressLint("MinMaxConstant")
    public static final float MIN_VISIBLE_CHANGE_SCALE = 1.0f / 500.0F;
    ...
    // View property id.
    private final FloatPropertyCompat mProperty;
    ...
    /**
     * This method is used to get the animation property of the Dynamic animation that we are building.
     *
     ...
     */
    private static <T> void removeNullEntries(@NonNull ArrayList<T> list) {
     ...
     */
    private static <T> void removeEntry(@NonNull ArrayList<T> list, T entry) {
    ...
    public void setAnimationHandler(@NonNull AnimationHandler animationHandler) {
        if (mRunning) {
            throw new AndroidRuntimeException("Animations are still running and the animation" + "handler should not be set at this timming");
        }
    ...
    public interface OnAnimationEndListener {
         ...
         */
        void onAnimationEnd(SpruceDynamics animation, boolean canceled, float value, float velocity);
    }
