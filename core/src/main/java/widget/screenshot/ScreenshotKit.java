...
public class ScreenshotKit {
    ...
    public static class Builder {
        ...
        private String fileNamePrefix = "截图";
        ...
        public ScreenshotKit show() {
            ...
            wrapper.addView(contentView, new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT));
            // 创建 AlertDialog
