...
public class ApkInstallManager {
    ...
    public void execute(File apkFile) {
        PermissionxKit.execute(appCompatActivity, true, PermissionKit.install(), R.string.installApplicationAreBasedOnThePermission, R.string.youNeedToAllowNecessaryPermissionInSettingManually, R.string.agree, R.string.refuse, new PermissionxKitListener() {
            @Override
