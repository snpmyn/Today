...
public class SaveHandler extends DataHandler {
     ...
     */
    void onSave(@NonNull LitePalSupport baseObj) throws SecurityException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
     ...
     */
    public <T extends LitePalSupport> void onSaveAll(Collection<T> collection) throws SecurityException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
     ...
     */
    private void doSaveAction(LitePalSupport baseObj, List<Field> supportedFields, List<Field> supportedGenericFields) throws SecurityException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        values.clear();
     ...
     */
    private void beforeSave(LitePalSupport baseObj, List<Field> supportedFields, ContentValues values) throws SecurityException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
     ...
     */
    private long saving(LitePalSupport baseObj, @NonNull ContentValues values) {
     ...
     * @param supportedGenericFields List of all supported generic fields.
     */
    private void doUpdateAction(LitePalSupport baseObj, List<Field> supportedFields, List<Field> supportedGenericFields) throws SecurityException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        values.clear();
     ...
     */
    private void beforeUpdate(LitePalSupport baseObj, List<Field> supportedFields, ContentValues values) throws SecurityException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        putFieldsValue(baseObj, supportedFields, values);
        putForeignKeyValue(values, baseObj);
     ...
     */
    @Nullable
    private Field getIdField(@NonNull List<Field> supportedFields) {
     ...
     */
    private void putForeignKeyValue(ContentValues values, @NonNull LitePalSupport baseObj) {
     ...
     * @param baseObj Current model that is persisted.
     */
    private void updateAssociatedTableWithFK(@NonNull LitePalSupport baseObj) {
     ...
     * @param baseObj Current model that is persisted.
     */
    private void clearFKValueInAssociatedTable(@NonNull LitePalSupport baseObj) {
     ...
     */
    private void insertIntermediateJoinTableValue(@NonNull LitePalSupport baseObj, boolean isUpdate) {
     ...
     */
    @NonNull
    private String getWhereForJoinTableToDelete(@NonNull LitePalSupport baseObj) {
     ...
     */
    private void updateGenericTables(LitePalSupport baseObj, @NonNull List<Field> supportedGenericFields, long id) throws IllegalAccessException, InvocationTargetException {
        for (Field field : supportedGenericFields) {
            ...
            if (collection != null) {
                Timber.tag(TAG).d("updateGenericTables: class name is " + baseObj.getClassName() + " , field name is " + field.getName());
