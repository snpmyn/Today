...
public class One2OneAnalyzer extends AssociationsAnalyzer {
     ...
     *                        {@link litepal.LitePalBase#getAssociationInfo(String)}.
     */
    private void dealAssociatedModel(LitePalSupport baseObj, LitePalSupport associatedModel, @NonNull AssociationsInfo associationInfo) {
     ...
     * @param associatedModel The associated model of baseObj.
     */
    private void bidirectionalCondition(LitePalSupport baseObj, @NonNull LitePalSupport associatedModel) {
