...
public class AssociationsInfo {
    ...
    /**
     * The field of the associated class to declare has association with self class.
     */
     ...
     *
     * @param associateOtherModelFromSelf The field which declares has association with other class to set.
     */
     ...
     *
     * @return The field of the associated class which declares has association with self class.
     */
     ...
     *
     * @param associateSelfFromOtherModel The field of the associated class which declares has association with self class to set.
     */
    ...
    /**
     * Override equals method to make sure that if two associated classes in the association info model are same ignoring sides,
     * they are same association info model.
     */
    @Override
    public boolean equals(Object o) {
        if (o instanceof AssociationsInfo) {
            ...
            if ((other.getAssociationType() == associationType) && other.getClassHoldsForeignKey().equals(classHoldsForeignKey)) {
                ...
                return other.getSelfClassName().equals(associatedClassName) && other.getAssociatedClassName().equals(selfClassName);
            }
        }
        return false;
    }
