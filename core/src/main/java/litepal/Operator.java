...
public class Operator {
     ...
     */
    public static void use(@NonNull LitePalDB litePalDB) {
     ...
     */
    public static int count(@NonNull Class<?> modelClass) {
     ...
     */
    @NonNull
    public static CountExecutor countAsync(@NonNull final Class<?> modelClass) {
        ...
        Runnable runnable = () -> {
            synchronized (LitePalSupport.class) {
                ...
                if (executor.getListener() != null) {
                    Operator.getHandler().post(() -> executor.getListener().onFinish(count));
                }
            }
        };
     ...
     */
    public static double average(@NonNull Class<?> modelClass, String column) {
     ...
     */
    @NonNull
    public static AverageExecutor averageAsync(@NonNull final Class<?> modelClass, final String column) {
    ...
    public static AverageExecutor averageAsync(final String tableName, final String column) {
        ...
        Runnable runnable = () -> {
            synchronized (LitePalSupport.class) {
                ...
                if (executor.getListener() != null) {
                    Operator.getHandler().post(() -> executor.getListener().onFinish(average));
                }
            }
        };
        executor.submit(runnable);
     ...
     */
    public static <T> T max(@NonNull Class<?> modelClass, String columnName, Class<T> columnType) {
     ...
     */
    @NonNull
    public static <T> FindExecutor<T> maxAsync(@NonNull final Class<?> modelClass, final String columnName, final Class<T> columnType) {
    ...
    public static <T> FindExecutor<T> maxAsync(final String tableName, final String columnName, final Class<T> columnType) {
        ...
        Runnable runnable = () -> {
            synchronized (LitePalSupport.class) {
                ...
                if (executor.getListener() != null) {
                    Operator.getHandler().post(() -> executor.getListener().onFinish(t));
                }
            }
        };
        executor.submit(runnable);
     ...
     */
    public static <T> T min(@NonNull Class<?> modelClass, String columnName, Class<T> columnType) {
     ...
     */
    @NonNull
    public static <T> FindExecutor<T> minAsync(@NonNull final Class<?> modelClass, final String columnName, final Class<T> columnType) {
     ...
     */
    public static <T> T sum(@NonNull Class<?> modelClass, String columnName, Class<T> columnType) {
     ...
     */
    @NonNull
    public static <T> FindExecutor<T> sumAsync(@NonNull final Class<?> modelClass, final String columnName, final Class<T> columnType) {
    ...
    public static UpdateOrDeleteExecutor deleteAsync(final Class<?> modelClass, final long id) {
        ...
        Runnable runnable = () -> {
            synchronized (LitePalSupport.class) {
                ...
                if (executor.getListener() != null) {
                    Operator.getHandler().post(() -> executor.getListener().onFinish(rowsAffected));
                }
            }
        };
        executor.submit(runnable);
     ...
     * @return The number of rows affected.
     */
    public static int updateAll(@NonNull Class<?> modelClass, ContentValues values, String... conditions) {
     ...
     */
    @NonNull
    public static UpdateOrDeleteExecutor updateAllAsync(@NonNull Class<?> modelClass, ContentValues values, String... conditions) {
    ...
    public static <T extends LitePalSupport> SaveExecutor saveAllAsync(final Collection<T> collection) {
        ...
        Runnable runnable = () -> {
            synchronized (LitePalSupport.class) {
                ...
                if (executor.getListener() != null) {
                    Operator.getHandler().post(() -> executor.getListener().onFinish(result));
                }
            }
        };
        executor.submit(runnable);
     ...
     */
    public static <T extends LitePalSupport> void markAsDeleted(@NonNull Collection<T> collection) {
        for (T t : collection) {
            t.clearSavedState();
        }
    }
