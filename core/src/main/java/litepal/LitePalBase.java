...
public abstract class LitePalBase {
     ...
     */
    private final OrmChange[] typeChangeRules = {new NumericOrm(), new TextOrm(), new BooleanOrm(), new DecimalOrm(), new DateOrm(), new BlobOrm()};
    /**
     * This is map of class name to fields list. Indicates that each class has which supported fields.
     */
    private final Map<String, List<Field>> classFieldsMap = new HashMap<>();
    /**
     * This is map of class name to generic fields list. Indicates that each class has which supported generic fields.
     */
    private final Map<String, List<Field>> classGenericFieldsMap = new HashMap<>();
    /**
     ...
     */
    protected Class<?> getGenericTypeClass(@NonNull Field field) {
     ...
     */
    private boolean isNonPrimitive(@NonNull Field field) {
     ...
     */
    protected boolean isPrivate(@NonNull Field field) {
     ...
     *                  {@link LitePalBase#GET_ASSOCIATION_INFO_ACTION}
     */
    private void oneToAnyConditions(String className, @NonNull Field field, int action) throws ClassNotFoundException {
        Class<?> fieldTypeClass = field.getType();
     ...
     *                  {@link LitePalBase#GET_ASSOCIATION_INFO_ACTION}
     */
    private void manyToAnyConditions(String className, @NonNull Field field, int action) throws ClassNotFoundException {
     ...
     */
    @NonNull
    private ColumnModel convertFieldToColumnModel(@NonNull Field field) {
