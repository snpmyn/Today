...
inline fun <reified T> LitePal.countAsync(): CountExecutor = countAsync(T::class.java)
...
inline fun <reified T> LitePal.averageAsync(column: String): AverageExecutor =
    averageAsync(T::class.java, column)
 ...
 */
inline fun <reified T, reified R> LitePal.max(columnName: String): R =
...
inline fun <reified T, reified R> LitePal.maxAsync(columnName: String): FindExecutor<R> =
 ...
 * @return The maximum value on a given column.
 */
inline fun <reified R> LitePal.max(tableName: String, columnName: String): R =
...
inline fun <reified R> LitePal.maxAsync(tableName: String, columnName: String): FindExecutor<R> =
 ...
 */
inline fun <reified T, reified R> LitePal.min(columnName: String): R =
...
inline fun <reified T, reified R> LitePal.minAsync(columnName: String): FindExecutor<R> =
 ...
 * @return The minimum value on a given column.
 */
inline fun <reified R> LitePal.min(tableName: String, columnName: String): R =
...
inline fun <reified R> LitePal.minAsync(tableName: String, columnName: String): FindExecutor<R> =
 ...
 */
inline fun <reified T, reified R> LitePal.sum(columnName: String): R =
...
inline fun <reified T, reified R> LitePal.sumAsync(columnName: String): FindExecutor<R> =
 ...
 * @return The sum value on a given column.
 */
inline fun <reified R> LitePal.sum(tableName: String, columnName: String): R =
...
inline fun <reified R> LitePal.sumAsync(tableName: String, columnName: String): FindExecutor<R> =
...
inline fun <reified T> LitePal.findAsync(id: Long): FindExecutor<T> = findAsync(T::class.java, id)
 ...
 * @return An object with found data from database, or null.
 */
inline fun <reified T> LitePal.find(id: Long, isEager: Boolean): T =
...
inline fun <reified T> LitePal.findAsync(id: Long, isEager: Boolean): T =
    find(T::class.java, id, isEager)
 ...
 */
inline fun <reified T> LitePal.findFirst(): T = findFirst(T::class.java)
...
inline fun <reified T> LitePal.findFirstAsync(): FindExecutor<T> = findFirstAsync(T::class.java)
 ...
 * @return An object with data of first row, or null.
 */
inline fun <reified T> LitePal.findFirst(isEager: Boolean): T = findFirst(T::class.java, isEager)
...
inline fun <reified T> LitePal.findFirstAsync(isEager: Boolean): FindExecutor<T> =
 ...
 */
inline fun <reified T> LitePal.findLast(): T = findLast(T::class.java)
...
inline fun <reified T> LitePal.findLastAsync(): FindExecutor<T> = findLastAsync(T::class.java)
 ...
 * @return An object with data of last row, or null.
 */
inline fun <reified T> LitePal.findLast(isEager: Boolean): T = findLast(T::class.java, isEager)
...
inline fun <reified T> LitePal.findLastAsync(isEager: Boolean): FindExecutor<T> =
 ...
 */
inline fun <reified T> LitePal.findAll(vararg ids: Long): MutableList<T> =
    findAll(T::class.java, *ids)
...
inline fun <reified T> LitePal.findAllAsync(vararg ids: Long): FindMultiExecutor<T> =
    findAllAsync(T::class.java, *ids)
 ...
 * @return An object list with found data from database, or an empty list.
 */
inline fun <reified T> LitePal.findAll(isEager: Boolean, vararg ids: Long): MutableList<T> =
...
inline fun <reified T> LitePal.findAllAsync(
    isEager: Boolean, vararg ids: Long
): FindMultiExecutor<T> = findAllAsync(T::class.java, isEager, *ids)
...
inline fun <reified T> LitePal.deleteAsync(id: Long): UpdateOrDeleteExecutor =
    deleteAsync(T::class.java, id)
...
inline fun <reified T> LitePal.deleteAllAsync(vararg conditions: String?): UpdateOrDeleteExecutor =
...
inline fun <reified T> LitePal.updateAsync(
    values: ContentValues, id: Long
): UpdateOrDeleteExecutor = updateAsync(T::class.java, values, id)
...
inline fun <reified T> LitePal.updateAllAsync(
    values: ContentValues, vararg conditions: String?
): UpdateOrDeleteExecutor = updateAllAsync(T::class.java, values, *conditions)
