...
inline fun <reified T> FluentQuery.findAsync(): FindMultiExecutor<T> = findAsync(T::class.java)
...
inline fun <reified T> FluentQuery.findAsync(isEager: Boolean): FindMultiExecutor<T> =
    findAsync(T::class.java, isEager)
