...
object LitePal {
     ...
     */
    @JvmStatic
    fun where(vararg conditions: String?): FluentQuery = Operator.where(*conditions)
     ...
     */
    @JvmStatic
    fun order(column: String?): FluentQuery = Operator.order(column)
     ...
     */
    @JvmStatic
    fun <T> find(modelClass: Class<T>, id: Long): T = Operator.find(modelClass, id)
     ...
     */
    @JvmStatic
    fun <T> findFirst(modelClass: Class<T>): T = Operator.findFirst(modelClass)
     ...
     */
    @JvmStatic
    fun <T> findLast(modelClass: Class<T>): T = Operator.findLast(modelClass)
     ...
     */
    @JvmStatic
    fun <T> findAll(modelClass: Class<T>, vararg ids: Long): MutableList<T> =
        Operator.findAll(modelClass, *ids)
     ...
     */
    @JvmStatic
    fun <T> findAll(modelClass: Class<T>, isEager: Boolean, vararg ids: Long): MutableList<T> =
