...
/**
 * This is a model class for generic table. It stores table name, value column name, value column type and value id column name.
 * This class is used to create generic tables when generic collection fields are declared in the model class.
 *
 * @author Tony Green
 * @since 1.4
 */
