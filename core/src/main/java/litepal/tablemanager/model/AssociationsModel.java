...
public class AssociationsModel {
    ...
    /**
     * The association type, including {@link litepal.util.Const.Model#MANY_TO_ONE},
     * {@link litepal.util.Const.Model#MANY_TO_MANY}, {@link litepal.util.Const.Model#ONE_TO_ONE}.
     */
     ...
     *
     * @param associationType Within {@link litepal.util.Const.Model#MANY_TO_ONE},
     *                        {@link litepal.util.Const.Model#MANY_TO_MANY},
     *                        {@link litepal.util.Const.Model#ONE_TO_ONE}.
     */
            ...
            if (association.getTableName() != null && association.getAssociatedTableName() != null) {
                if ((association.getAssociationType() == associationType) && tableHoldsForeignKey.equals(association.getTableHoldsForeignKey())) {
                    if (association.getTableName().equals(tableName) && association.getAssociatedTableName().equals(associatedTableName) && association.getTableHoldsForeignKey().equals(tableHoldsForeignKey)) {
                        ...
                        return association.getTableName().equals(associatedTableName) && association.getAssociatedTableName().equals(tableName) && association.getTableHoldsForeignKey().equals(tableHoldsForeignKey);
                }
            }
        }
        return false;
