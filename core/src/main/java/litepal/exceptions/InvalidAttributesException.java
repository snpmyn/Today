...
/**
 * Reading the attributes in the litepal.xml file. Check all the attributes if they are valid value.
 * If anyone of them is not under rules, throw InvalidAttributesException exception.
 *
 * @author Tony Green
 * @since 1.0
 */
